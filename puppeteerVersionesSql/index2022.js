...
async function getDataFromWebPage() {
    ...
    const results = await page.evaluate(() => {
        const secondOxa = document.querySelectorAll('div.oxa')[1];
        let data = [];
...
BEGIN
    ...
    VALUES ('2022','${row.build}', '${row.fileVersion}', '${row.kbDescription}', '${row.releaseDate}');
END
ELSE
BEGIN
    UPDATE versionesSql
...
END;\n\n`;
    ...
    fs.writeFileSync('versionesSql2022.sql', sqlScript);
